...
const Navbar4 = () => {
  return (
<div class="bg-gradient-to-r from-green-600 via-red-800 to-orange-500 auto-h-screen">  
...
<ul className="space-y-4 -mt-2">
  <li className="bg-gray-200 rounded-lg p-4 hover:bg-purple-200 transition duration-300">
