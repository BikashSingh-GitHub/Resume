...
import { purple, indigo, blue, teal, green } from "@material-ui/core/colors";
...
const Navbar = () => {
  return (
    <ThemeProvider theme={theme}>
      <nav className="bg-gradient-to-r from-indigo-600 to-purple-500 via-blue-500 via-teal-500 to-green-500 h-44">
